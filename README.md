...
1 つの mixi2 Plugin アプリケーションをコミュニティにインストールし、そのコミュニティへカテゴリタグ付きで投稿します。
...
mixi2 Developer Platform で Plugin アプリケーションを 1 つ作成し、投稿先コミュニティにインストールします。この Plugin は arXiv から取得した内容をコミュニティに投稿するだけなので、イベント受信用の Webhook URL や Stream Address は使いません。

Developer Platform では次の設定を行ってください。
